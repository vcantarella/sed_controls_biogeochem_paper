...
#facies
aspect = 30
ax1 = axs_d["b. facies 3-D facies-based"]
...
ax2 = axs_d["d. $K$ 3-D facies-based"]
...
ax3 = axs_d["f. TOC 3-D facies-based"]
...
fig1.savefig("model_slice_pub1_v7.png", dpi=1000, bbox_inches='tight')
fig2.savefig("model_slice_pub2_v7.png", dpi=1000, bbox_inches='tight')
